export default {
  ...
  mods: {
    ...
    openFolder: '打开目录',
    launchGame: '启动游戏',
    pickModFile: '选择 Mod 文件',
    pickModFilter: 'Mod 文件',
    dllCount: '个 dll',
    looseDll: '散装 dll',
    searchPlaceholder: '搜索 Mod...',
    modCount: '个 Mod',
    deleteTitle: '删除 Mod',
    deleteFolderHint: '将删除整个文件夹及其所有文件，不可撤销。',
    deleteDllHint: '将永久删除此文件，不可撤销。',
    dragHint: '松开以安装 Mod',
    dragSub: '支持 .zip 压缩包 和 .dll 文件',
    installing: '正在安装...',
    installSuccess: '安装成功',
    installSuccessUrl: '下载并安装成功',
    // URL 弹窗
    urlTitle: '通过 URL 安装 Mod',
    urlHint: '输入 .zip 或 .dll 的直链地址，将自动下载并安装到插件目录。',
    urlPlaceholder: 'https://example.com/MyMod.zip',
    urlDownload: '下载并安装',
    // 冲突弹窗
    conflictTitle: '文件夹已存在',
    conflictMsg: '插件目录中已存在名为',
    conflictMsgSuffix: '的文件夹，请选择处理方式：',
